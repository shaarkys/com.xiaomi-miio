...
function createNumericValueMap(min, max) {
  const to_device = {};
  const from_device = {};

  for (let value = min; value <= max; value += 1) {
    to_device[value] = value;
    from_device[value] = String(value);
  }
  ...
  'xiaomi.airp.cpa5': {
    ...
    properties: {
      get_properties: [
        ...
        { did: 'filter_life_remaining', siid: 4, piid: 1 },
        { did: 'filter_hours_used', siid: 4, piid: 3 },
        { did: 'light', siid: 6, piid: 2 },
        { did: 'buzzer', siid: 7, piid: 1 },
        { did: 'child_lock', siid: 8, piid: 1 },
        { did: 'fanlevel', siid: 9, piid: 1 }
      ],
      set_properties: {
        power: { siid: 2, piid: 1 },
        mode: { siid: 2, piid: 3 },
    ...
    value_maps: {
      mode: {
        to_device: { 0: 0, 1: 1, 2: 2 },
        from_device: { 0: '0', 1: '1', 2: '2' }
      },
      fanlevel: createNumericValueMap(0, 14)
    }
  }
};
